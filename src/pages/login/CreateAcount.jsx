...
const CreateAccount = () => {
  ...
  const [privUser, setPrivUser] = useState("Usuario");
  ...
  const handleCreateAccount = async () => {
    if (password === confirmPassword) {
      try {
        await createAccount({ user, email, password, privUser });
      } catch (err) {
        console.log(err);
      }
    } else {
  ...
  //esto es una variable para probar, tienes que cambierana
  const privUser1 = "User"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 1500">
            ...
            <g transform="rotate(0 0 0)">
              <g transform="rotate(0 0 0)">
                ...
                <circle fill-opacity="0.02" fill="url(#a)" r="3000" />
              </g>
            </g>
          </svg>
        </div>
          ...
          <div className="bg-gray-500">
            ...
            <div>
              <div className="flex flex-col gap-2">
                <Checkbox isSelected={isSelected} onValueChange={setIsSelected}>
                  <NextUILink
                    showAnchorIcon
                    href="TODO--redirect_to_terms_of_use"
                    color="primary"
                  >
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setPrivUser(e.target.checked ? "Admin" : "Client")
                }
              />
            </div>

            <div className="bg-red-500">
              <Button onClick={handleCreateAccount} color="primary">Siguiente</Button>
            </div>
          </div>
        </div>
      </div>
